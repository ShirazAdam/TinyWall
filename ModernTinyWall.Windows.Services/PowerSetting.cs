...
namespace ModernTinyWall.Windows.Services
{
    public static class PowerSetting
    {
        ...
        public static readonly Guid GUID_ACDC_POWER_SOURCE = new(
            0x5D3E9A59, 0xE9D5, 0x4B00, 0xA6, 0xBD, 0xFF, 0x34, 0xFF, 0x51, 0x65, 0x48
        );

        // A7AD8041-B45A-4CAE-87A3-EECBB468A9E1
        public static readonly Guid GUID_BATTERY_PERCENTAGE_REMAINING = new(
