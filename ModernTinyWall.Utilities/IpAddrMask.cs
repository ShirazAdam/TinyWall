...
namespace ModernTinyWall.Utilities
{
    public sealed class IpAddrMask : IEquatable<IpAddrMask>
    {
        ...
        private static readonly byte[] LinkLocalBytes = [169, 254, 0, 0];

        private static readonly byte[] IPv6LinkLocalBytes = [0xFE, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];

        private static readonly byte[] MulticastBytes = [224, 0, 0, 0];

        private static readonly byte[] AdminScopedMulticastBytes = [239, 192, 0, 0];

        private static readonly byte[] IPv6MulticastBytes = [0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];

        private static readonly byte[] IPv6LinkLocalMulticastBytes = [0xFF, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
