...
namespace ImmenseWall.ViewModels
{
    ...
    public class SettingsViewModel : ViewModelBase
    {
        ...
        private List<ExceptionListItem> _allExceptions = new();
        ...
        private void InitializeLanguages()
        {
            ...
            SelectedLanguage = Languages.FirstOrDefault(l => l.Id.Equals(_tmpConfig.Controller.Language, StringComparison.OrdinalIgnoreCase))
                             ?? Languages.First();
        }
