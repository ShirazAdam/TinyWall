...
using ImmenseWall.Services.TaskDialogue;
...
namespace ImmenseWall.Services
{
    ...
    internal static class Utils
    {
        ...
        */
        ...
        internal static DialogResult ShowMessageBox(string msg, string title, TaskDialogCommonButtons buttons, ImmenseWall.Services.TaskDialogue.TaskDialogIcon icon, IWin32Window? parent = null)
        {
